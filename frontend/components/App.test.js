...
// test('B is in the correct position after movement', () => {
//   render(<AppFunctional />);

//   // Check that "B" is in the initial position (center)
//   expect(screen.getByText('B')).toBeInTheDocument();

//   // Simulate movement (e.g., click "UP")
//   fireEvent.click(screen.getByText(/UP/i));

//   // Check if "B" has moved to the correct position
//   // You should verify the grid position manually based on expected behavior
//   expect(screen.getByText('B')).toBeInTheDocument();
// });